...
Downloaded files are called <i>course name</i> + <i>video name</i> + "#" + <i>video_chapter</i>+'_'+<i>video_number</i> + <i>mp4</i> (example: "_Learning_Java_-_Wha_is_Java_.mp4")<br><br>
