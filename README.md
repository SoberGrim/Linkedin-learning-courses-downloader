...
www.linkedin.com/learning has lots of learning courses, that you would possibly want to download for further watching.
...
On the same page "Upload unpacked extension" -> choose folder with this plugin (it will be shown as empty) Press OK.
